...
func (s *OrderService) List(ctx *gin.Context, req controller.ListRequest) (*controller.ListResponse[*domain.Order], error) {
	// tbd: empty implementation
	return &controller.ListResponse[*domain.Order]{}, nil
}
